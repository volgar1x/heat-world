...
public final class PlayerTraderRemoveItemEvent extends PlayerTraderEvent {
    
    private final WorldItem item;

    public PlayerTraderRemoveItemEvent(PlayerTrade trade, PlayerTrader trader, WorldItemWallet wallet, WorldItem item) {
